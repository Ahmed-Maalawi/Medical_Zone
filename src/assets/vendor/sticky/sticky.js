...
(function ($) {
	...
	$.fn.themePin = function (options) {
		...
		$(this).on('https://www.portotheme.com/html/wolmart/assets/vendor/sticky/recalc.pin', function () {
			recalculateLimits();
			onScroll();
		});

		$(this).on('https://www.portotheme.com/html/wolmart/assets/vendor/sticky/recalc.pinleft', function (e, timeout) {
		...
		build: function () {
			...
			$(window).smartresize(function () {
				...
				stickyResizeTrigger = setTimeout(function () {
					$el.trigger('https://www.portotheme.com/html/wolmart/assets/vendor/sticky/recalc.pin');
				}, 800);
	...
	$.fn.themeSticky = function (opts) {
		return this.map(function () {
			...
			if ($this.data(instanceName)) {
				$this.trigger('https://www.portotheme.com/html/wolmart/assets/vendor/sticky/recalc.pin');
				setTimeout(function () {
					$this.trigger('https://www.portotheme.com/html/wolmart/assets/vendor/sticky/recalc.pin');
				}, 800);
